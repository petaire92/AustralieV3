...
class X2MenuBar: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
    ...
    var rootController : X2ViewController?
    let gfx = Gfx()
    ...
    override func viewDidLoad() {
        ...
        customCollectionView.register(X2MenuCell.self, forCellWithReuseIdentifier: cellId)
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = customCollectionView.dequeueReusableCell(withReuseIdentifier: cellId, for: indexPath) as! X2MenuCell
